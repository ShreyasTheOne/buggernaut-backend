    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=datetime.datetime.now, verbose_name='time published')),
                ('assigned_to', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='issue_assigned_to_user', to=settings.AUTH_USER_MODEL)),
